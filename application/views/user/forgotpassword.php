    ...
    <body class="login-page">
        <div class="login-box">
            ...
            <div class="login-box-body">
                <h3 class="login-box-msg"><?php echo getlang('forget_password'); ?></h3>
                ...
                <form action="<?php echo base_url(); ?>resetPasswordUser" method="post">
                    <div class="form-group has-feedback">
                        <input type="email" class="form-control" placeholder="<?php echo getlang('email'); ?>" name="login_email" required />
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                        <input type="submit" class="btn btn-primary btn-block btn-flat" value="<?php echo getlang('submit'); ?>" />
                        </div>
                    </div>
                    <input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
                </form>
                <a href="<?php echo base_url() ?>"><?php echo getlang('login'); ?></a><br>
            </div>
        </div>
