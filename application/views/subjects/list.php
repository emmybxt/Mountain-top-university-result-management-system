<?php 
    ...
    $page_title = getlang('subject_manage');
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-4 text-right">
                <a class="btn btn-primary" href="<?php echo base_url(); ?>subjects/add"><i class="fa fa-plus"></i> <?php echo getlang('add_new'); ?></a>
            </div>
        </div>
            ...
            <div class="col-xs-12 rms-data-table">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><?php echo getlang('subject_list'); ?></h3>
                        <div class="box-tools">
                            <form action="<?php echo base_url() ?>subjects" method="POST" id="searchList">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-sm btn-info" href="<?php echo base_url().'subjects/add/'.$record->id; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
    ...
    jQuery(document).ready(function(){
        ...
        **/
        jQuery(document).on("click", ".deleteSubject", function(){
            var Id = $(this).data("id"),
            hitURL = baseURL + "subjects/delete",
            currentRow = $(this);
