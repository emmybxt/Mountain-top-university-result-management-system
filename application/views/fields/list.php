    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-4 text-right">
                <a class="btn btn-primary" href="<?php echo base_url(); ?>fields/add"><i class="fa fa-plus"></i> <?php echo getlang('add_new'); ?></a>
            </div>
        </div>
            ...
            <div class="col-xs-12 rms-data-table">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><?php echo getlang('field_list'); ?></h3>
                        <div class="box-tools">
                            <form action="<?php echo base_url() ?>fields" method="POST" id="searchList">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover rms-table">
                            <tr>
                                <th><?php echo getlang('field_name'); ?></th>
                                <th><?php echo getlang('type'); ?></th>
                                <th><?php echo getlang('section'); ?></th>
                                <th><?php echo getlang('field_order'); ?></th>
                                <th><?php echo getlang('publishe'); ?> </th>
                            ...
                            <tr>  
                                ...
                                <td class="text-center">
                                    <a class="btn btn-sm btn-info"  href="<?php echo base_url().'fields/add/'.$record->id; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
                                    <a class="btn btn-sm btn-danger deleteFields"data-id="<?php echo $record->id; ?>" id="fieldId" href="#" name="Id" title="Delete"><i class="fa fa-trash"></i></a>
                                </td>
        ...
        jQuery(document).on("click", ".deleteFields", function(){
            ...
            if(confirmation)
            {
                ...
                data : { Id : Id, '<?php echo $this->security->get_csrf_token_name(); ?>': '<?php echo $this->security->get_csrf_hash(); ?>' } 
                    ...
                    if(data.status = true) { alert("Field successfully deleted"); }
                    else if(data.status = false) { alert("Field deletion failed"); }
